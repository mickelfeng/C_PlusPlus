...
public:
    ...
    void publicShow(void)
    {
        std::cout << i << std::endl;
    }
    
    friend void prt_friend(Prt& prt);
    
private:
    int i;
    void privateShow(void)
    {
        std::cout << i << std::endl;
    }
};
...
#define retTest(Type, number)  ({ \
                typeof(Type)* ptr ;\
                ptr = createObj<typeof(Type),typeof(number)>(number); \
                ptr;\
                                })


int main(void){
//     ASD<int>* as = new ASD<int>(1);
    int i =2;
    ASD<int>* as = retTest(ASD<int>,i);
// 展开后如下:
//    ASD<int>* as =({
//        typeof(ASD<int>) *ptr;
//        ptr=createObj<typeof(ASD<int>),typeof(i)>(i);
//        ptr;
//    });
    return 0;
}
